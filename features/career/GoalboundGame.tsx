...
export const GoalboundGame = observer(function GoalboundGame() {
  ...
  const { game, player, scenario, achievements, canRequestTransfer, canReviewAgent, availableAgents, trophyTotals, draft, motion, trophyRoom } = store;
      ...
      <main className="site-shell">
        ...
        {game.screen === "career" && player && (
          <CareerScreen
            ...
            onAgentReview={store.startAgentReview}
            onAgentChoice={store.chooseAgent}
