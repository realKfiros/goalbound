...
export function SummaryScreen({ player, onReset }: { player: Player; onReset: () => void }) {
  return (
    <section className="summary-page page-enter">
      ...
      <div className="summary-actions"><button className="primary-button" onClick={onReset}>Start another career <span>↻</span></button></div>
    </section>
  );
}
